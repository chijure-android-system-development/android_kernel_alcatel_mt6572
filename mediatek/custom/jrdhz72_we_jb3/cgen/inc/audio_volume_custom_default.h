...
#include "Digicel/audio_volume_custom_default.h"

#elif defined(JRD_PANASONIC_AUDIO_PARAM)
#include "Panasonic/audio_volume_custom_default.h"

#elif !defined(MTK_2IN1_SPK_SUPPORT)
#include "EU/audio_volume_custom_default.h"

#else
#include "US/audio_volume_custom_default.h"
#endif
