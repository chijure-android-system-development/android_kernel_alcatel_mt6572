...
// Added by Xiaodong.chen for support atv-out at 2013.6.27
#ifdef NMIXXX_XTV_SUPPORT
extern bool g_bIsAtvStart;
#endif
// Added end

//ting.kang add for Distinguish the different camera
static int flag;
//ting.kang end 
...
void GC0329NightMode(kal_bool bEnable)
{
	...
	{	
		...
		if(GC0329_MPEG4_encode_mode == KAL_TRUE)
			GC0329_write_cmos_sensor(0x33, 0x30);	//zrl optimize switching to sub camera color effort,130821
		else
	...
	else 
	{
		GC0329_write_cmos_sensor(0xfe, 0x01);
		if(GC0329_MPEG4_encode_mode == KAL_TRUE)
			GC0329_write_cmos_sensor(0x33, 0x20);	//zrl optimize switching to sub camera color effort,130821
		else
...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0x73, 0x8b);
	GC0329_write_cmos_sensor(0x74, 0x80);
	GC0329_write_cmos_sensor(0x75, 0x80);
	GC0329_write_cmos_sensor(0x76, 0x8b);

	GC0329_write_cmos_sensor(0x42, 0x00);
	GC0329_write_cmos_sensor(0x77, 0x68);///57
	GC0329_write_cmos_sensor(0x78, 0x3d);///4d
	GC0329_write_cmos_sensor(0x79, 0x45);///45
	...
	/*qiangbo.ni modify (from 0x17 to 0x15) PLL driver ability @20131122 */
	GC0329_write_cmos_sensor(0x24, 0x15);//qiangbo.ni change 16 to 17
	/*qiangbo.ni modify end @20131122 */
	////////////////////blk////////////////////
	GC0329_write_cmos_sensor(0x26, 0xf7); 
	GC0329_write_cmos_sensor(0x29, 0x80); 
	GC0329_write_cmos_sensor(0x32, 0x04);
	GC0329_write_cmos_sensor(0x33, 0x17);
	GC0329_write_cmos_sensor(0x34, 0x17);
	GC0329_write_cmos_sensor(0x35, 0x17);
	GC0329_write_cmos_sensor(0x36, 0x17);
	...
	GC0329_write_cmos_sensor(0xb4, 0x00);
	...
	GC0329_write_cmos_sensor(0x17, 0x89);
	...
	GC0329_write_cmos_sensor(0x51, 0x18);  //10
	GC0329_write_cmos_sensor(0x52, 0x10);  //0b
	GC0329_write_cmos_sensor(0x53, 0x02);  //30//16
	GC0329_write_cmos_sensor(0x54, 0x46);  //40
	...
	GC0329_write_cmos_sensor(0x69, 0x90);  //b0
	...
	GC0329_write_cmos_sensor(0xac, 0x1b);
	GC0329_write_cmos_sensor(0xad, 0x1e);
	...
	GC0329_write_cmos_sensor(0xb4, 0x27);
	GC0329_write_cmos_sensor(0xb5, 0x0e);
	GC0329_write_cmos_sensor(0xb6, 0x10);
	GC0329_write_cmos_sensor(0xba, 0x3e);
	GC0329_write_cmos_sensor(0xbb, 0x15);
	GC0329_write_cmos_sensor(0xbc, 0x13);
	GC0329_write_cmos_sensor(0xc0, 0x0f);
	GC0329_write_cmos_sensor(0xc1, 0x06);
	GC0329_write_cmos_sensor(0xc2, 0x06);
	GC0329_write_cmos_sensor(0xc6, 0x0d);
	GC0329_write_cmos_sensor(0xc7, 0x06);
	...
	GC0329_write_cmos_sensor(0xc3, 0x02);
	GC0329_write_cmos_sensor(0xc4, 0x09);
	GC0329_write_cmos_sensor(0xc5, 0x08);
	...
	GC0329_write_cmos_sensor(0xb5, 0x06);
	GC0329_write_cmos_sensor(0xb6, 0xfa);
	GC0329_write_cmos_sensor(0xb7, 0x46);
	GC0329_write_cmos_sensor(0xb8, 0xf0);
	...
	GC0329_write_cmos_sensor(0x09, 0xee);
	GC0329_write_cmos_sensor(0x50, 0xfc);
	GC0329_write_cmos_sensor(0x51, 0x28);  //10
	GC0329_write_cmos_sensor(0x52, 0x18);  //0b
	GC0329_write_cmos_sensor(0x53, 0x10);  //30//16
	GC0329_write_cmos_sensor(0x54, 0x08);  //40
	GC0329_write_cmos_sensor(0x55, 0x10);
	GC0329_write_cmos_sensor(0x56, 0x24);
	//GC0329_write_cmos_sensor(0x57, 0x40);
	...
	GC0329_write_cmos_sensor(0x6a, 0x40);
	GC0329_write_cmos_sensor(0x6b, 0x39);
	GC0329_write_cmos_sensor(0x6c, 0x16);
	GC0329_write_cmos_sensor(0x6d, 0x0d);
	GC0329_write_cmos_sensor(0x6e, 0x41);
...
#if defined(NMIXXX_XTV_SUPPORT) && defined(JRD_BUILD_MMITEST)
...
void GC0329_Write_More_Registers(void)
{
	...
	GC0329_write_cmos_sensor(0xa5,0x41);																																																																									
	GC0329_write_cmos_sensor(0xa7,0x30);																																																																									
...
//ting.kang add for Distinguish the different camera
    mt_set_gpio_mode(GPIO29,GPIO_MODE_00);
    mt_set_gpio_pull_enable(GPIO29, GPIO_PULL_DISABLE);
    mt_set_gpio_dir(GPIO29,GPIO_DIR_IN);
    flag = mt_get_gpio_in(GPIO29);
    GC0329_Sensor_Init();
    if (flag){
        GC0329_Write_More_Registers();
    }
...

{
	...
	mdelay(300);	//zrl optimize switching to sub camera color effort,130821
        ...
        MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    */
    ...
    pSensorInfo->PreviewDelayFrame = 4;	//zrl optimize switching to sub camera color effort,130821
...
BOOL GC0329_set_param_wb(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AWB_MODE_AUTO:
			GC0329_write_cmos_sensor(0x77, 0x68);	
			GC0329_write_cmos_sensor(0x78, 0x3d);
...
//ting.kang add for Distinguish the different camera
        if(flag){	
//zrl optimize switching to sub camera color effort begin,130821	
	value_luma = (GC0329_NIGHT_MODE?0x2b:0x03);///00
	value_Y = (GC0329_NIGHT_MODE?0x80:0x60);////68//50//60
//zrl optimize switching to sub camera color effort end,130821	
        }
        else{
	     value_luma = (GC0329_NIGHT_MODE?0x2b:0x02);///00
	     value_Y = (GC0329_NIGHT_MODE?0x80:0x5d);////68//50//60             
        }
//ting.kang end
...
// Added by Xiaodong.Chen at 2013.7.2 for atv/dtv out
#ifdef NMIXXX_XTV_SUPPORT
