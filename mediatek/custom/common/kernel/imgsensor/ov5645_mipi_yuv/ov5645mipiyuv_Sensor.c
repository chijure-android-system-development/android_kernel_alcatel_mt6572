...
kal_uint32 OV5645MIPI_GetSensorID(kal_uint32 *sensorID)
{
	...
	for(i=0;i<3;i++)
	{
		...
		printk("OV5645MIPI READ ID: %x",sensor_id);
...
static void OV5645_FOCUS_OVT_AFC_Init(void)
{
   OV5645MIPI_write_cmos_sensor(0x3000, 0x20);        // reset MCU
	 ...
	 iBurstWriteReg(firmware1, 242, OV5645MIPI_WRITE_ID);
	 iBurstWriteReg(firmware2, 242, OV5645MIPI_WRITE_ID);
	 iBurstWriteReg(firmware3, 242, OV5645MIPI_WRITE_ID);
	 iBurstWriteReg(firmware4, 242, OV5645MIPI_WRITE_ID);
	 iBurstWriteReg(firmware5, 242, OV5645MIPI_WRITE_ID);
	 iBurstWriteReg(firmware6, 242, OV5645MIPI_WRITE_ID);
	 iBurstWriteReg(firmware7, 242, OV5645MIPI_WRITE_ID);
	 iBurstWriteReg(firmware8, 242, OV5645MIPI_WRITE_ID);
	 iBurstWriteReg(firmware9, 242, OV5645MIPI_WRITE_ID);
	 iBurstWriteReg(firmware10, 242, OV5645MIPI_WRITE_ID);
	 iBurstWriteReg(firmware11, 242, OV5645MIPI_WRITE_ID);
	 iBurstWriteReg(firmware12, 242, OV5645MIPI_WRITE_ID);
	 iBurstWriteReg(firmware13, 242, OV5645MIPI_WRITE_ID);
	 iBurstWriteReg(firmware14, 242, OV5645MIPI_WRITE_ID);
	 iBurstWriteReg(firmware15, 242, OV5645MIPI_WRITE_ID);
	 iBurstWriteReg(firmware16, 242, OV5645MIPI_WRITE_ID);
	 iBurstWriteReg(firmware17, 242, OV5645MIPI_WRITE_ID);
	 iBurstWriteReg(firmware18, 242, OV5645MIPI_WRITE_ID);
	 iBurstWriteReg(firmware19, 242, OV5645MIPI_WRITE_ID);
	 iBurstWriteReg(firmware20, 242, OV5645MIPI_WRITE_ID);
	 iBurstWriteReg(firmware21, 242, OV5645MIPI_WRITE_ID);
	 iBurstWriteReg(firmware22, 242, OV5645MIPI_WRITE_ID);
	 iBurstWriteReg(firmware23, 213, OV5645MIPI_WRITE_ID);
...
UINT32 OV5645MIPIGetInfo(MSDK_SCENARIO_ID_ENUM ScenarioId,MSDK_SENSOR_INFO_STRUCT *pSensorInfo,MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	pSensorInfo->CaptureDelayFrame = 1;  //nqb modify from 3 to 1 @2013-10-29
...
BOOL OV5645MIPI_set_param_wb(UINT16 para)
{
	...
	switch (para)
    {
        ...
        case AWB_MODE_FLUORESCENT:
        	    			OV5645MIPI_write_cmos_sensor(0x3212,0x02); 
							OV5645MIPI_set_AWB_mode(KAL_FALSE);                           
							OV5645MIPI_write_cmos_sensor(0x3400,0x04); //0x04
							OV5645MIPI_write_cmos_sensor(0x3401,0x30); //0x00
							OV5645MIPI_write_cmos_sensor(0x3402,0x04); //0x04
							OV5645MIPI_write_cmos_sensor(0x3403,0x00); //0x00
							OV5645MIPI_write_cmos_sensor(0x3404,0x06); //0x06
...
void OV5645MIPI_scene_mode_PORTRAIT()
{
	...
	/*ccm*/		
	OV5645MIPI_write_cmos_sensor(0x5381,0x22);//0x22   //ccm
	OV5645MIPI_write_cmos_sensor(0x5382,0x55);//0x55
	OV5645MIPI_write_cmos_sensor(0x5383,0x12);//0x12
	...
	OV5645MIPI_write_cmos_sensor(0x538a,0x01);//0x01
	OV5645MIPI_write_cmos_sensor(0x538b,0x98);//0x98  	
