...
FTABLE_SCENE_INDEP()
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                "320x240","640x480","800x480","1024x768","1280x768","1280x960","1600x1200","2048x1536","2200x1320","2880x1728","2560x1920"/*      "2560x1920",*/ /*zhao.li@tcl 13.6.29 add 1280x768 "2560x1536"for Bug 480655*/
            )
        ), 
    )
#endif
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                "176x144",      "320x240",      "352x288",      "640x480",      "720x480",    "800x480",	"1280x768",/*zhao.li@tcl 13.6.28 add 800x4801280x768 for Bug 480655*/
            )
        ), 
    )
#endif
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                "176x144","320x240","352x288","640x480","720x480","800x480","1024x768", /*zhao.li@tcl 13.6.28 add 800x480 for Bug 480655*//*hongqi.tian.hz@tcl 13.8.22 add 800x480 for Bug 506845*/
            )
        ), 
    )
#endif
