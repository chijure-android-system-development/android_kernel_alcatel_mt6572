...
int flash_mode;	//video-mode-flashlight 2; capture-mode-flashlight 1
...
int FL_dim_duty(kal_uint32 duty)
{
    ...
    g_duty=duty;
    reg1=(g_duty+1)*8;
    if(1 == flash_mode)	//capture-mode-flashlight limit current 500mA
	{	
		if(reg1>80)
    		reg1=80;
    }
	else	//video-mode-flashlight limit current 200mA
	{
		if(reg1>32)
    		reg1=32;		
	}
