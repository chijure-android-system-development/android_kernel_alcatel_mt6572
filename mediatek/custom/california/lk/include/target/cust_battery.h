...
#define MAX_CHARGE_TEMPERATURE  45 //mingquan.lai set to 45 according to company standard
...
#define BATT_ID_CHECK_SUPPORT       1       //mingquan.lai adds to support battery id check for California(do not check in MMI version)
#endif
