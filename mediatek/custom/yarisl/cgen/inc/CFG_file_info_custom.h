...
#if 1
   const TCFG_FILE g_akCFG_File_Custom0[]=
    {
        {
     ...
     const TCFG_FILE g_akCFG_File_Custom1[]=
    {
        ...
        {
            "/data/nvram/APCFG/APRDCL/Sph_Dual_Mic",       VER(AP_CFG_RDCL_FILE_DUAL_MIC_CUSTOM_LID),         CFG_FILE_SPEECH_DUAL_MIC_SIZE,
            CFG_FILE_SPEECH_DUAL_MIC_TOTAL,           SIGNLE_DEFUALT_REC,                (char *)&dual_mic_custom_default1, DataReset , NULL
        },
        ...
        {
            "/data/nvram/APCFG/APRDCL/Audio_ver1_Vol_custom",       VER(AP_CFG_RDCL_FILE_AUDIO_VER1_VOLUME_CUSTOM_LID),         CFG_FILE_AUDIO_VER1_VOLUME_CUSTOM_REC_SIZE,
            CFG_FILE_AUDIO_VER1_VOLUME_CUSTOM_REC_TOTAL,           SIGNLE_DEFUALT_REC,                (char *)&audio_ver1_custom_default1, DataReset , NULL
        },
    ...
    const unsigned int g_i4CFG_File_Custom_Count = sizeof(g_akCFG_File_Custom0)/sizeof(TCFG_FILE);
