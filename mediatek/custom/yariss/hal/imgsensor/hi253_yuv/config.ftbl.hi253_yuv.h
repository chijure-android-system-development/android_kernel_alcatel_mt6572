...
FTABLE_SCENE_INDEP()
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                "176x144",      "320x240",      "352x288",      "427x320",      "480x320",      "480x368", 
                "640x480",      "720x480",      "800x480",      "800x600",      "864x480", 
                "960x540",      "1024x768",      "1280x720",      "1280x768",/*zhao.li@tcl 13.5.27 add 1280x768 for Bug 459062,modified by hongqi.tian.hz@tcl 13.9.2 for CR517136*/
            )
        ), 
    )
#endif
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_("320x240"), 
            ITEM_AS_VALUES_(
                "176x144",      "320x240",     "480x320",      "640x480",      "600x400", /*zhao.li@tcl 13.5.27 add 800x480 for Bug 459062,modified by hongqi.tian.hz@tcl 13.9.2 for CR517136*/
                "864x480",      "1024x768",      "1050x700"
            )
        ), 
    )
#endif
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                ...
                MtkCameraParameters::ON,  //zhao.li@tcl Add for zsd mode Bug 466783
            )
        ), 
    )
#endif
