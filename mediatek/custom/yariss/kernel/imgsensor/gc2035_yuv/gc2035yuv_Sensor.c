...
kal_uint32 GC2035_isp_master_clock = 0;
...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0xb3 , 0x5e);
	...
	GC2035_write_cmos_sensor(0x13 , 0x72);//y_target
	GC2035_write_cmos_sensor(0xfe , 0x00);
	...
	GC2035_write_cmos_sensor(0xc4 , 0x17);
	GC2035_write_cmos_sensor(0xc8 , 0x30);
	GC2035_write_cmos_sensor(0xc9 , 0x21);
	GC2035_write_cmos_sensor(0xca , 0x1a);
	GC2035_write_cmos_sensor(0xbc , 0x39);
	GC2035_write_cmos_sensor(0xbd , 0x2a);
	GC2035_write_cmos_sensor(0xbe , 0x14);
	GC2035_write_cmos_sensor(0xb6 , 0x53);
	GC2035_write_cmos_sensor(0xb7 , 0x2c);
	GC2035_write_cmos_sensor(0xb8 , 0x2d);
	GC2035_write_cmos_sensor(0xc5 , 0x05);
	GC2035_write_cmos_sensor(0xc6 , 0x00);
	GC2035_write_cmos_sensor(0xc7 , 0x0a);
	GC2035_write_cmos_sensor(0xcb , 0x03);
	GC2035_write_cmos_sensor(0xcc , 0x00);
	GC2035_write_cmos_sensor(0xcd , 0x07);
	GC2035_write_cmos_sensor(0xbf , 0x1a);
	GC2035_write_cmos_sensor(0xc0 , 0x0c);
	GC2035_write_cmos_sensor(0xc1 , 0x1f);
	GC2035_write_cmos_sensor(0xb9 , 0x03);
	...
	GC2035_write_cmos_sensor(0xac , 0x17);
	...
	GC2035_write_cmos_sensor(0xb1 , 0x1b);
	GC2035_write_cmos_sensor(0xb2 , 0x14);
	GC2035_write_cmos_sensor(0xb3 , 0x1f);
	GC2035_write_cmos_sensor(0xb4 , 0x1c);
	GC2035_write_cmos_sensor(0xb5 , 0x20);
	GC2035_write_cmos_sensor(0xd0 , 0x00);
	GC2035_write_cmos_sensor(0xd2 , 0x02);
	GC2035_write_cmos_sensor(0xd3 , 0x13);
	...
	GC2035_write_cmos_sensor(0xde , 0x05);
	...
	*/
	...
	GC2035_write_cmos_sensor(0x4e , 0x00); //00
	GC2035_write_cmos_sensor(0x4e , 0x02); //00
	GC2035_write_cmos_sensor(0x4e , 0x02);
	GC2035_write_cmos_sensor(0x4d , 0x80);//add
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x00); //20
	GC2035_write_cmos_sensor(0x4e , 0x00);
	...
	GC2035_write_cmos_sensor(0x56 , 0x0e);
	...
	GC2035_write_cmos_sensor(0xde , 0xb4);  //b6
...
BOOL GC2035_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x72);
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2035_SET_PAGE1;
