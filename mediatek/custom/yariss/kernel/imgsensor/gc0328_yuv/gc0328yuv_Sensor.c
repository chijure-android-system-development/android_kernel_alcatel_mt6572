...
#define GC0328YUV_DEBUG//zhao.li@tcl open this for debug
...
void GC0328_Sensor_Init(void)
{
	...
	GC0328_write_cmos_sensor(0x4f , 0x00);  
	GC0328_write_cmos_sensor(0x4f , 0x00);
	GC0328_write_cmos_sensor(0x4d , 0x33);
	GC0328_write_cmos_sensor(0x4e , 0x04);
	GC0328_write_cmos_sensor(0x4e , 0x02);
	GC0328_write_cmos_sensor(0x4e , 0x02);
	GC0328_write_cmos_sensor(0x4e , 0x02);
	GC0328_write_cmos_sensor(0x4e , 0x02);
	GC0328_write_cmos_sensor(0x4d , 0x41);
	GC0328_write_cmos_sensor(0x4e , 0x08);
	GC0328_write_cmos_sensor(0x4e , 0x08);
	GC0328_write_cmos_sensor(0x4e , 0x08);
	GC0328_write_cmos_sensor(0x4e , 0x02);//D50
	GC0328_write_cmos_sensor(0x4e , 0x02); // d65 add
	GC0328_write_cmos_sensor(0x4d , 0x51);
	GC0328_write_cmos_sensor(0x4e , 0x08); //08 
	GC0328_write_cmos_sensor(0x4e , 0x08);
	GC0328_write_cmos_sensor(0x4e , 0x08);
	GC0328_write_cmos_sensor(0x4e , 0x04);  //D65
	GC0328_write_cmos_sensor(0x4e , 0x00);  //D65
	GC0328_write_cmos_sensor(0x4d , 0x63);
	GC0328_write_cmos_sensor(0x4d , 0x10);
	//GC0328_write_cmos_sensor(0x4e , 0x00);  //10 //
	...
	GC0328_write_cmos_sensor(0x17 , 0x17);//lizhao 0x14);    
	...
	///////YCP
	GC0328_write_cmos_sensor(0xd1 , 0x2c);//0x28--4.15
	GC0328_write_cmos_sensor(0xd2 , 0x2c);//0x28--4.15
	...
	GC0328_write_cmos_sensor(0x13 , 0x44);   
	...
	GC0328_write_cmos_sensor(0xfe , 0x01);
GC0328_write_cmos_sensor(0xc0 , 0x18);    
GC0328_write_cmos_sensor(0xc1 , 0x0f);    
GC0328_write_cmos_sensor(0xc2 , 0x11);    
GC0328_write_cmos_sensor(0xc6 , 0x14);    
GC0328_write_cmos_sensor(0xc7 , 0x0d);    
GC0328_write_cmos_sensor(0xc8 , 0x0c);    
GC0328_write_cmos_sensor(0xba , 0x2b);    
GC0328_write_cmos_sensor(0xbb , 0x17);    
GC0328_write_cmos_sensor(0xbc , 0x17);    
GC0328_write_cmos_sensor(0xb4 , 0x28);    
GC0328_write_cmos_sensor(0xb5 , 0x19);    
GC0328_write_cmos_sensor(0xb6 , 0x18);    
GC0328_write_cmos_sensor(0xc3 , 0x08);    
GC0328_write_cmos_sensor(0xc4 , 0x0c);    
...
GC0328_write_cmos_sensor(0xbd , 0x08);    
GC0328_write_cmos_sensor(0xbe , 0x05);    
GC0328_write_cmos_sensor(0xbf , 0x00);    
GC0328_write_cmos_sensor(0xb7 , 0x06);    
GC0328_write_cmos_sensor(0xb8 , 0x02);    
GC0328_write_cmos_sensor(0xb9 , 0x00);    
GC0328_write_cmos_sensor(0xa8 , 0x40);    
GC0328_write_cmos_sensor(0xa9 , 0x32);    
GC0328_write_cmos_sensor(0xaa , 0x2a);    
GC0328_write_cmos_sensor(0xab , 0x49);    
GC0328_write_cmos_sensor(0xac , 0x3e);    
GC0328_write_cmos_sensor(0xad , 0x42);    
GC0328_write_cmos_sensor(0xae , 0x2f);    
GC0328_write_cmos_sensor(0xaf , 0x1f);    
GC0328_write_cmos_sensor(0xb0 , 0x1e);    
GC0328_write_cmos_sensor(0xb1 , 0x54);    
GC0328_write_cmos_sensor(0xb2 , 0x42);    
GC0328_write_cmos_sensor(0xb3 , 0x41);    
	...
	GC0328_write_cmos_sensor(0xB4 , 0xf5);   
...
BOOL GC0328_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC0328_write_cmos_sensor(0xd5, 0xf8);//0x00--4.15
			GC0328_write_cmos_sensor(0xfe, 0x01);
			GC0328_write_cmos_sensor(0x13, 0x44);//0x45--4.15
			GC0328_write_cmos_sensor(0xfe, 0x00);
		break;
