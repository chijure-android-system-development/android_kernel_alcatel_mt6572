...
OV2659_write_cmos_sensor(0x504b,0xf0);	
    ...
    //r
    OV2659_write_cmos_sensor(0x500c, 0x03);//03
    OV2659_write_cmos_sensor(0x500d, 0x10);//20
    OV2659_write_cmos_sensor(0x500e, 0x02);//02
    OV2659_write_cmos_sensor(0x500f, 0x40);//40
    OV2659_write_cmos_sensor(0x5010, 0x41);//43
    OV2659_write_cmos_sensor(0x5011, 0x00);
    OV2659_write_cmos_sensor(0x5012, 0x66);
    //g
    OV2659_write_cmos_sensor(0x5013, 0x03);//03
    OV2659_write_cmos_sensor(0x5014, 0x28);//20
    OV2659_write_cmos_sensor(0x5015, 0x02);//02
    OV2659_write_cmos_sensor(0x5016, 0x40);//40
    OV2659_write_cmos_sensor(0x5017, 0x39);//39
    OV2659_write_cmos_sensor(0x5018, 0x00);
    OV2659_write_cmos_sensor(0x5019, 0x66);
    //b
    OV2659_write_cmos_sensor(0x501a, 0x03);//03
    OV2659_write_cmos_sensor(0x501b, 0x18);//20
    OV2659_write_cmos_sensor(0x501c, 0x02);//02
    OV2659_write_cmos_sensor(0x501d, 0x40);//40
    OV2659_write_cmos_sensor(0x501e, 0x34);//36
    ...
    OV2659_write_cmos_sensor(0x5085,0x3c);//34		   
...
static void OV2659PreviewSetting(void)
{
	...
	printk("OV2659FullSizeCaptureSetting--0x3503=0x%X,0x3500=0x%X,0x3501=0x%X,0x3502=0x%X,0x350B=0x%X,0x3a00=0x%X\n",
		OV2659_read_cmos_sensor(0x3503),
		OV2659_read_cmos_sensor(0x3500),
		OV2659_read_cmos_sensor(0x3501),
		OV2659_read_cmos_sensor(0x3502),
		OV2659_read_cmos_sensor(0x350B),
		OV2659_read_cmos_sensor(0x3a00));
	spin_lock(&ov2659_drv_lock);
...
static void OV2659FullSizeCaptureSetting(void)
{
	...
	OV2659_write_cmos_sensor(0X0100, 0X00);	
	//OV2659_write_cmos_sensor(0X4202, 0X0f);
	...
	OV2659_write_cmos_sensor(0x380c, 0x07); 
 	...
 	OV2659_write_cmos_sensor(0x4003, 0x88);            	
	OV2659_write_cmos_sensor(0X0100, 0X01);	
	//OV2659_write_cmos_sensor(0X4202, 0X00);
	printk("OV2659FullSizeCaptureSetting--0x3503=0x%X,0x3a00=0x%X\n",
		OV2659_read_cmos_sensor(0x3503),
		OV2659_read_cmos_sensor(0x3a00));
...
{	
	...
	//OV2659InitialSetting();
	printk("OV2659Preview----0x3406=0x%X----\n",OV2659_read_cmos_sensor(0x3406));
...
void OV2659Set3ACtrl(ACDK_SENSOR_3A_LOCK_ENUM action)
{
   ...
   switch (action)
   {
	...
	printk("OV2659Set3ACtrl----SENSOR_3A_AE_LOCK----\n");
          OV2659_set_AE_mode(KAL_FALSE);
      break;
      case SENSOR_3A_AE_UNLOCK:
	printk("OV2659Set3ACtrl----SENSOR_3A_AE_UNLOCK----\n");
          OV2659_set_AE_mode(KAL_TRUE);
      break;
      case SENSOR_3A_AWB_LOCK:
	printk("OV2659Set3ACtrl----SENSOR_3A_AWB_LOCK----\n");
          OV2659_set_AWB_mode(KAL_FALSE);
      break;
      case SENSOR_3A_AWB_UNLOCK:
	printk("OV2659Set3ACtrl----SENSOR_3A_AWB_UNLOCK----\n");
          OV2659_set_AWB_mode(KAL_TRUE);
      break;
      default:
	printk("OV2659Set3ACtrl----default----\n");
      	break;
   }
