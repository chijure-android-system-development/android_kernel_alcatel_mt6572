...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0x33, 0x18);//bug 605630 [yaris35][camera]GC0329 tuning parameter update by lizhao 0x20-->0x18
	if(gc0329_module==1)
		{
		GC0329_write_cmos_sensor(0x34, 0x1d);//bug 605630 [yaris35][camera]GC0329 tuning parameter update by lizhao 0x26-->0x1d		
		}
	else
		{
	GC0329_write_cmos_sensor(0x34, 0x18);//bug 605630 [yaris35][camera]GC0329 tuning parameter update by lizhao 0x20-->0x18
		}	
	GC0329_write_cmos_sensor(0x35, 0x18);//bug 605630 [yaris35][camera]GC0329 tuning parameter update by lizhao 0x20-->0x18
	GC0329_write_cmos_sensor(0x36, 0x18);//bug 605630 [yaris35][camera]GC0329 tuning parameter update by lizhao 0x20-->0x18
	...
	GC0329_write_cmos_sensor(0x70, 0x50);///48
	...
	GC0329_write_cmos_sensor(0xb4, 0x00);//fd
	GC0329_write_cmos_sensor(0xb5, 0xfd);//02
...
if(gc0329_module==1)
{
	...
	GC0329_write_cmos_sensor(0x13, 0x4D);//0x50
...
void GC0329_Write_More_Registers(void)
{
	...
	GC0329_write_cmos_sensor(0xa0,0xaf);																																																																									
	GC0329_write_cmos_sensor(0xa2,0xff);																																																																									
	GC0329_write_cmos_sensor(0xa4,0x10);//20  /////60																																																																								
	GC0329_write_cmos_sensor(0xa5,0x51);//41	//////31																																																																								
	GC0329_write_cmos_sensor(0xa7,0x35);																																																																									
        ...
        MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    */
    ...
    pSensorInfo->PreviewDelayFrame = 3;  //0--4.1 
