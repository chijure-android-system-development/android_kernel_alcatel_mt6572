...
//int SEN_CSI2_ENABLE = 0;//lizhao P82
int SEN_CSI2_ENABLE = 1;//lizhao p82
...
SeninfDrv::SeninfDrv()
{
    ...
    mUsers = 0;
    mfd = 0;
    tg1GrabWidth = 0;//lizhao p82
    tg1GrabHeight = 0;	//lizhao p82
}
...
)
{
    ...
    tg1GrabWidth = pixelEnd - pixelStart;//lizhao p82
    tg1GrabHeight = lineEnd - lineStart;//lizhao p82
