...
MultiShot(
    ...
    , mThumbImgBufInfoTemp()//fengke add mtk path JRD542827 for PR542794 camera continuous shot gallery thumb display error 2013.10.24
	, mFocusValRead()	
	, mFocusValWrite()
	, mFocusValReady()
	, mFocusVal()
...
start(SensorParam const & rSensorParam, MUINT32 u4ShotCount)
{
    ...
    mThumbImgBufInfoTemp = queryThumbTempImgBufInfo(); //fengke add mtk path JRD542827 for PR542794 camera continuous shot gallery thumb display error 2013.10.24
...
//fengke add mtk path JRD542827 for PR542794 camera continuous shot gallery thumb display error 2013.10.24 start
MBOOL
MultiShot::
convertImage(ImgBufInfo const & rSrcImgBufInfo, ImgBufInfo const & rDstImgBufInfo, int rot)
{
    ...
    if (rot == 90 || rot == 270)//mtk path JRD542827
	{
...
//fengke add mtk path JRD542827 for PR542794 camera continuous shot gallery thumb display error 2013.10.24 end
...
queryThumbYuvImgBufInfo()
{
    ...
    mThumbnailMem.push_back(thumbnailMem);//fengke add mtk path JRD542827 for PR542794 camera continuous shot gallery thumb display error 2013.10.24
    FUNCTION_LOG_END;
