...
static void mapNode2ImgInfo(EHwBufIdx const &idx, ImgBufQueNode const &src, IhwScenario::PortImgInfo &dst);//lizhao p82
...
//lizhao p82 end
    ...
    if ( dispNode.getImgBuf() != 0)
    {
        ...
        mapNode2ImgInfo(eID_Pass2DISPO, dispNode, ImgInfo);//lizhao p82
        //lizhao p82 mapNode2ImgInfo(eID_Pass2DISPO, dispNode, ImgInfo,cameraInfo);
