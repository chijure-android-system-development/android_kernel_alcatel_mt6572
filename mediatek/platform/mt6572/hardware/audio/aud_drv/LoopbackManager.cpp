...
// Modified for FR590070 begin by yi.zheng.hz@tcl.com
loopback_t LoopbackManager::GetLoopbackTypeNoLock()
{
    ALOGV("%s(), mLoopbackType = %d", __FUNCTION__, mLoopbackType);
    return mLoopbackType;
}
// Modified for FR590070 end
...
// Modified for FR590070 begin by yi.zheng.hz@tcl.com, move below code here
