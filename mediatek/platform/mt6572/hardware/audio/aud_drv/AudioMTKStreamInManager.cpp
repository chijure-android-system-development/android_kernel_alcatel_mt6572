            ...
            switch (Client->mMemDataType) {
                case AudioDigitalType::MEM_VUL:
                    ...
                    if (mVULThread.get() && !checkMemInUse(Client)) {
                         //susheng.ye merge patch JRD503150(For_JRDHZ72_WE_JB3_ALPS.JB3.MP.V1_P58) FR504781 begin
                        ...
                        mAudioDigital->SetMemIfEnable(Client->mMemDataType, false);
                         //susheng.ye merge patch JRD503150(For_JRDHZ72_WE_JB3_ALPS.JB3.MP.V1_P58) FR504781 end
