...
/*[PR673706][Yaris35][charge]change battery init place by [wangxingxing] at [20140512] begin*/
struct platform_device battery_device = {
    .name   = "battery",
    .id        = -1,
};
/*[PR673706][Yaris35][charge]change battery init place by [wangxingxing] at [20140512] end*/
/*=======================================================================*/
