 ...
 */
 ...
 // CR589333  modified  by yongming.li for meta 
 
#define MT6575_UART1_PHY_BASE 0x11006000

#define MT6575_UART1_LSR *(volatile unsigned char *)(MT6575_UART1_PHY_BASE+0x14)
#define MT6575_UART1_THR *(volatile unsigned char *)(MT6575_UART1_PHY_BASE+0x0)

static inline void putc(int c)
{
    while (!(MT6575_UART1_LSR & 0x20));    
    MT6575_UART1_THR = c;      
}
