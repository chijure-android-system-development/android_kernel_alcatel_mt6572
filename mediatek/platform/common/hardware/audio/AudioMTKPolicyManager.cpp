...
void AudioMTKPolicyManager::setForceUse(AudioSystem::force_use usage, AudioSystem::forced_config config)
{
    ...
    case AudioSystem::FOR_PROPRIETARY:
        ...
        mForceUse[usage] = config;
        break;  
//Modified for PR598441 by yi.zheng.hz at 2014-02-09 begin
    case AudioSystem::FOR_VIBSPK:
        if (config != AudioSystem::FORCE_NONE &&
            config != AudioSystem::FORCE_SPEAKER) {
            ALOGW("setForceUse() invalid config %d for FOR_VIBSPK", config);
        }
        mForceUse[usage] = config;
        break;
//Modified for PR598441 by yi.zheng.hz at 2014-02-09 end
#endif                
    default:
...
status_t AudioMTKPolicyManager::dump(int fd)
{
    ...
    result.append(buffer);
//Modified for PR598441 by yi.zheng.hz at 2014-02-09 begin
    snprintf(buffer, SIZE, " Force use for vibspk %d\n", mForceUse[AudioSystem::FOR_VIBSPK]);
    result.append(buffer);
//Modified for PR598441 by yi.zheng.hz at 2014-02-09 end
#endif    
...
audio_devices_t AudioMTKPolicyManager::getNewDevice(audio_io_handle_t output, bool fromCache)
{
    ...
    //Modified for PR598441 by yi.zheng.hz at 2014-02-09 begin
    if((mForceUse[AudioSystem::FOR_VIBSPK] == AudioSystem::FORCE_SPEAKER)
		/*&&(outputDesc->isUsedByStrategy(STRATEGY_VIBSPK))*/
		&& (mPhoneState == AudioSystem::MODE_RINGTONE))
    //Modified for PR598441 by yi.zheng.hz at 2014-02-09 end
    {
                                                             ...
                                                             bool fromCache)
{
    ...
    case STRATEGY_VIBSPK:
        //Added force speaker-vibrating by yi.zheng.hz at 2014-02-09 begin
        if(!isInCall() && mForceUse[AudioSystem::FOR_VIBSPK] == AudioSystem::FORCE_SPEAKER)
        //Added force speaker-vibrating by yi.zheng.hz at 2014-02-09 end
        {
            //(mPhoneState == AudioSystem::MODE_RINGTONE)
            device = mAvailableOutputDevices & AudioSystem::DEVICE_OUT_SPEAKER;
    ...
    case STRATEGY_PHONE:
        ...
        //Modified for PR598441 by yi.zheng.hz at 2014-02-09 begin
        #if 0
        if((mPhoneState == AudioSystem::MODE_RINGTONE)&&(mForceUse[AudioSystem::FOR_VIBSPK] == AudioSystem::FORCE_SPEAKER))
        {
    ...
    case STRATEGY_MEDIA: {
        ...
        //Modified for PR598441 by yi.zheng.hz at 2014-02-09 begin
        #if 0
        if((mForceUse[AudioSystem::FOR_VIBSPK] == AudioSystem::FORCE_SPEAKER)&&(strategy == STRATEGY_SONIFICATION) && (mPhoneState == AudioSystem::MODE_RINGTONE) &&
                                            ...
                                            audio_devices_t device)
{
    ...
    {
	     //Modified by rifang.zhang.hz for PR571075 begin
        char bootShutVolume[10];
        property_get("ro.device.boot.volume",bootShutVolume,"0.3");
        volume = atof(bootShutVolume);//BOOT_ANIMATION_VOLUME;
        ALOGD("boot animation vol= %f",volume);
		//Modified by rifang.zhang.hz for PR571075 end
    }
#else
