...
status_t A2dpAudioInterface::startVoiceBuffer(int duration)
{
    //return mHardwareInterface->startVoiceBuffer(duration);
    return 0;
}

status_t A2dpAudioInterface::stopVoiceBuffer()
{
    //return mHardwareInterface->stopVoiceBuffer();
    return 0;
}

status_t A2dpAudioInterface::playVoiceBuffer()
{
    //return mHardwareInterface->playVoiceBuffer();
    return 0;
}

status_t A2dpAudioInterface::cleanVoiceBuffer()
{
    //return mHardwareInterface->cleanVoiceBuffer();
    return 0;
}

status_t A2dpAudioInterface::voiceBufferDisable()
{
    //return mHardwareInterface->voiceBufferDisable();
    return 0;
}

status_t A2dpAudioInterface::dealWithAbnormalCallHangup()
{
    //return mHardwareInterface->dealWithAbnormalCallHangup();
    return 0;
}

status_t A2dpAudioInterface::initStartVoiceBufferWithoutPTTCall()
{
    //return mHardwareInterface->initStartVoiceBufferWithoutPTTCall();
    return 0;
}
// caorongxing add end
