...
class AudioHardwareStub : public  AudioHardwareBase
{
    public:
        ...
        virtual status_t startVoiceBuffer(int duration){return NO_ERROR;}
        virtual status_t stopVoiceBuffer(void) {return NO_ERROR;}
        virtual status_t playVoiceBuffer(void) {return NO_ERROR;}
        virtual status_t cleanVoiceBuffer(void) {return NO_ERROR;}
        virtual status_t voiceBufferDisable(void) {return NO_ERROR;}
        virtual status_t dealWithAbnormalCallHangup(void) {return NO_ERROR;}
        virtual status_t initStartVoiceBufferWithoutPTTCall(void) {return NO_ERROR;}
        // caorongxing add end
    protected:
        virtual status_t    dump(int fd, const Vector<String16> &args);
