...
class AudioMTKHardwareInterface
{
    public:
       ...
       virtual status_t startVoiceBuffer(int duration) = 0;
       virtual status_t stopVoiceBuffer(void) = 0;
       virtual status_t playVoiceBuffer(void) = 0;
       virtual status_t cleanVoiceBuffer(void) = 0;
       virtual status_t voiceBufferDisable(void)= 0;
       virtual status_t dealWithAbnormalCallHangup(void) = 0;
       virtual status_t initStartVoiceBufferWithoutPTTCall(void) = 0;
       // caorongxing add end
};
