...
/* Added by yeqing.yan start */
    A2M_VOICEBUFFER_PLAY = CCCI_MSG_A2M_BASE | 0x8B,
    A2M_VOICEBUFFER_CLEAN,
    A2M_VOICEBUFFER_STOP,
    A2M_VOICEBUFFER_routing_begin,
    A2M_VOICEBUFFER_routing_end,
...
/* Add by yeqing.yan start */
    M2A_VB_PLAY_STARTED = CCCI_MSG_M2A_BASE + 0xd1,
    M2A_VB_PLAY_COMPLETED,
    M2A_VB_PLAY_ABORTED,
    M2A_VB_PLAY_ERROR,
