...
bool AudioHardwareGeneric::getVoiceUnlockDLInstance()
{
 return 0;
   ...
   status_t AudioHardwareGeneric::startVoiceBuffer(int duration){return NO_ERROR;}
   status_t AudioHardwareGeneric::stopVoiceBuffer(void) {return NO_ERROR;}
   status_t AudioHardwareGeneric::playVoiceBuffer(void) {return NO_ERROR;}
   status_t AudioHardwareGeneric::cleanVoiceBuffer(void) {return NO_ERROR;}
   status_t AudioHardwareGeneric::voiceBufferDisable(void) {return NO_ERROR;}
   status_t AudioHardwareGeneric::dealWithAbnormalCallHangup(void) {return NO_ERROR;}
   status_t AudioHardwareGeneric::initStartVoiceBufferWithoutPTTCall(void) {return NO_ERROR;}
   // caorongxing add end
