...
bool AudioHardwareBase::getVoiceUnlockDLInstance()
{
 return 0;
   ...
   status_t AudioHardwareBase::startVoiceBuffer(int duration){return NO_ERROR;}
   status_t AudioHardwareBase::stopVoiceBuffer(void) {return NO_ERROR;}
   status_t AudioHardwareBase::playVoiceBuffer(void) {return NO_ERROR;}
   status_t AudioHardwareBase::cleanVoiceBuffer(void) {return NO_ERROR;}
   status_t AudioHardwareBase::voiceBufferDisable(void) {return NO_ERROR;}
   status_t AudioHardwareBase::dealWithAbnormalCallHangup(void) {return NO_ERROR;}
   status_t AudioHardwareBase::initStartVoiceBufferWithoutPTTCall(void) {return NO_ERROR;}
   // caorongxing add end
