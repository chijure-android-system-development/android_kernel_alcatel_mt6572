...
void dod_init(void)
{
    ...
    #endif
/*[PR668937][Yaris35][batterymeter]modified by [wangxingxing] at [20140507] begin*/
	...
	if(bat_is_charger_exist() == KAL_TRUE)
		{
		          ...
		          if(((g_rtc_fg_soc != 0) && ((g_rtc_fg_soc-gFG_capacity_by_v) < 40) &&(( gFG_capacity_by_v > 5 || bat_is_charger_exist() == KAL_TRUE)))
					|| ((g_rtc_fg_soc != 0) &&(g_boot_reason == BR_WDT_BY_PASS_PWK || g_boot_reason == BR_WDT || g_boot_mode == RECOVERY_BOOT)))
...
/*[PR668937][Yaris35][batterymeter]modified by [wangxingxing] at [20140507] begin*/
    ...
    //{
   	...
   	//}
/*[PR668937][Yaris35][batterymeter]modified by [wangxingxing] at [20140507] end*/
