    ...
    else
    {
        ...
        {    
			...
			/* Set CV */
				...
				#else    
				//wangxingxing20131209 changed for FR568943 start
					      if((BMT_status.temperature >= BATTERY_TEMPERATURE_45)&&(BMT_status.temperature < BATTERY_TEMPERATURE_55))
						  	 cv_voltage = BATTERY_VOLT_04_100000_V;
		                                       ...
		                                       cv_voltage = BATTERY_VOLT_04_175000_V;
                                                    ...
                                                    cv_voltage = BATTERY_VOLT_04_200000_V;
                                             #endif
			     //wangxingxing20131209 changed for FR568943 end
				#endif
			#endif
