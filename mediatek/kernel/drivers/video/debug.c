...
extern unsigned int mtkfb_fm_auto_test();//zhao.li@tcl bug 481348 P28
extern UINT32 color;//zhao.li@tcl bug 481348 P28
...
#if 0
        disp_path_clock_off("reg_backup");//zhao.li@tcl bug 481348 P28
#endif
    }
    else if (0 == strncmp(opt, "resume", 6))
    {
#if 0
        disp_path_clock_on("reg_restore");//zhao.li@tcl bug 481348 P28
#endif
